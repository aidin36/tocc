...
TEST_CASE("front_end: delete file")
{
  ...
  file_stream1.open(testdb_path("tocc_test_file_to_delete_1").c_str());
  file_stream1 << "data...";
  file_stream1.close();

  // Creating a file to import.
  std::ofstream file_stream2;
  file_stream2.open(testdb_path("tocc_test_file_to_delete_2").c_str());
  file_stream2 << "data...";
  file_stream2.close();

  //Creating files for collection
  std::ofstream file_stream3;
  file_stream3.open(testdb_path("tocc_test_file_to_delete_3").c_str());
  file_stream3 << "data...";
  file_stream3.close();

  std::ofstream file_stream4;
  file_stream4.open(testdb_path("tocc_test_file_to_delete_4").c_str());
  file_stream4 << "data...";
  file_stream4.close();

  std::ofstream file_stream5;
  file_stream5.open(testdb_path("tocc_test_file_to_delete_5").c_str());
  file_stream5 << "data...";
  file_stream5.close();

  //Creating files for array's ids
  std::ofstream file_stream6;
  file_stream6.open(testdb_path("tocc_test_file_to_delete_6").c_str());
  file_stream6 << "data...";
  file_stream6.close();

  std::ofstream file_stream7;
  file_stream7.open(testdb_path("tocc_test_file_to_delete_7").c_str());
  file_stream7 << "data...";
  file_stream7.close();

  std::ofstream file_stream8;
  file_stream8.open(testdb_path("tocc_test_file_to_delete_8").c_str());
  file_stream8 << "data...";
  file_stream8.close();
  ...
  libtocc::FileInfo test_file1 =
      manager.import_file(testdb_path("tocc_test_file_to_delete_1").c_str());

  libtocc::FileInfo test_file2 =
      manager.import_file(testdb_path("tocc_test_file_to_delete_2").c_str());

  std::string file_id = std::string(test_file1.get_id());

  //FileInfoCollection
  libtocc::FileInfo test_file3 =
      manager.import_file(testdb_path("tocc_test_file_to_delete_3").c_str());

  libtocc::FileInfo test_file4 =
      manager.import_file(testdb_path("tocc_test_file_to_delete_4").c_str());

  libtocc::FileInfo test_file5 =
      manager.import_file(testdb_path("tocc_test_file_to_delete_5").c_str());
  ...
  libtocc::FileInfo test_file6 =
      manager.import_file(testdb_path("tocc_test_file_to_delete_6").c_str());

  libtocc::FileInfo test_file7 =
      manager.import_file(testdb_path("tocc_test_file_to_delete_7").c_str());

  libtocc::FileInfo test_file8 =
      manager.import_file(testdb_path("tocc_test_file_to_delete_8").c_str());
