...
#ifndef TOCCCLI_UNASSIGN_ACTION_H_INCLUDED
#define TOCCCLI_UNASSIGN_ACTION_H_INCLUDED
...
namespace tocccli
{
  ...
  /*
   * This action unassign tags to files.
   */
  class UnassignAction : public Action
  {
  public:

    UnassignAction(libtocc::Manager* manager);
...
#endif /* TOCCCLI_UNASSIGN_ACTION_H_INCLUDED */
